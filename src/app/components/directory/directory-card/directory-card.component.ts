...
@Component({
  ...
  template: `
    <a [routerLink]="['/contacto', contact.id]"
       class="block bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md hover:border-indigo-300 transition-all duration-200 group">
      <div class="p-4">
